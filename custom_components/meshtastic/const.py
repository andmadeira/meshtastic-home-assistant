...
EVENT_MESHTASTIC_MESSAGE_LOG_EVENT_DATA_ATTR_RX_RSSI: Final = "rx_rssi"
EVENT_MESHTASTIC_MESSAGE_LOG_EVENT_DATA_ATTR_HOP_START: Final = "hop_start"
EVENT_MESHTASTIC_MESSAGE_LOG_EVENT_DATA_ATTR_HOP_LIMIT: Final = "hop_limit"
...
class MeshtasticDomainMessageLogEventData(TypedDict):
    ...
    EVENT_MESHTASTIC_MESSAGE_LOG_EVENT_DATA_ATTR_RX_SNR: float
    EVENT_MESHTASTIC_MESSAGE_LOG_EVENT_DATA_ATTR_RX_RSSI: int
    EVENT_MESHTASTIC_MESSAGE_LOG_EVENT_DATA_ATTR_HOP_START: int
    EVENT_MESHTASTIC_MESSAGE_LOG_EVENT_DATA_ATTR_HOP_LIMIT: int
